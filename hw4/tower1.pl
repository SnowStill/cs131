...
plain_tower(N, T, C) :-
    ...
    maplist(unique_list2(Perlist, N), T, Left),

    transpose(T, Ttrans),
    maplist(unique_list2(Perlist, N), Ttrans, Top),

    maplist(reverse, T, Trev),
    maplist(unique_list2(Perlist, N), Trev, Right),

    maplist(reverse, Ttrans, Ttransrev),
    maplist(unique_list2(Perlist, N), Ttransrev, Bottom).
